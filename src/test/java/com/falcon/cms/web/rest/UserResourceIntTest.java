...
import com.falcon.cms.domain.Authority;
import com.falcon.cms.domain.User;
import com.falcon.cms.repository.UserRepository;
import com.falcon.cms.security.AuthoritiesConstants;
import com.falcon.cms.service.MailService;
import com.falcon.cms.service.UserService;
import com.falcon.cms.service.dto.UserDTO;
import com.falcon.cms.service.mapper.UserMapper;
import com.falcon.cms.web.rest.errors.ExceptionTranslator;
import com.falcon.cms.web.rest.vm.ManagedUserVM;
...
public class UserResourceIntTest {
    ...
    public void testUserDTOtoUser() {
        UserDTO userDTO = new UserDTO(
            ...
            DEFAULT_LOGIN,
            null,
            Stream.of(AuthoritiesConstants.ADMIN).collect(Collectors.toSet()));
        ...
        assertThat(user.getAuthorities()).extracting("name").containsExactly(AuthoritiesConstants.ADMIN);
    }
